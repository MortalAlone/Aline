...
function(e) {
				...
				return c.destroy = function() {
					...
					if (f && (r = t(s, e || {}), this.options = r, this.state = {}, r.scrollSmooth && (r.duration = r.scrollSmoothDuration, c.scrollSmooth = n(5).initSmoothScrolling(r)), l = a(r), i = u(r), this._buildHtml = l, this._parseContent = i, c.destroy(), null !== (d = i.selectHeadings(r.contentSelector, r.headingSelector)))) {
						...
						return l.render(r.tocSelector, h), this._scrollListener = o(function(e) {
							...
							(e && (0 === e.eventPhase || null === e.currentTarget) || t) && (r.scrollEndCallback && r.scrollEndCallback(e))
	...
	e.exports = function(e) {
		...
		function o(t) {
			...
			}) : o.textContent = t.textContent, o.setAttribute("href", "#" + t.id), o.setAttribute("class", e.linkClass + e.extraLinkClasses), n.appendChild(o), n
		}
		function l(t) {
			var n = document.createElement("ul"),
				o = "sidebar-links"
				if (t) o = e.listClass;
			return t && o, n.setAttribute("class", o), n
		...
		function s(t) {
			...
			if (m && null !== document.querySelector(e.tocSelector) && l.length > 0) {
				...
				var a = document.querySelector(e.tocSelector).querySelector("." + e.linkClass + '[href="#' + o.id + '"]'); - 1 === a.className.indexOf(e.activeLinkClass) && (a.className += h + e.activeLinkClass);
                var p = a.parentNode;
